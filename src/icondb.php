...
return [
    ...
    [
        [
            ...
            ["text-icon", ["medium-blue", "medium-blue"], "/\\.te?xt$|\\.irclog$|\\.uot$/i", null, false, null, null, null, "/^\\xEF\\xBB\\xBF|^\\xFF\\xFE/"],
            ["text-icon", ["medium-maroon", "medium-maroon"], "/\\.log$|^Terminal[-_\\s]Saved[-_\\s]Output$|\\.brf$/i"],
            ["text-icon", ["dark-red", "dark-red"], "/\\.git[\\/\\\\]description$/", null, true],
